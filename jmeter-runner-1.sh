...

{
        ...
        do
                ...
                $(pwd)/bin/jmeter -n -t $1 -l $TEST_DIR/test-result.jtl -J testNum=$testNum -J IP=$IP -J URI=${URI//////} -J port=$port -J username=$username -J password=$password -J verb=$verb -J numThreads=$numThreads -J requestsPerThread=$requestsPerThread -J bodyFile=$bodyFile -J rampUpTime=$rampUpTime -J testDuration=$testDuration
